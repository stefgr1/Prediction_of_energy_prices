...
# Access future_covariates_columns from utils
...
def main():
    ...
    # Set up TensorBoard logging for Optuna and model training
    tb_logger = pl_loggers.TensorBoardLogger(save_dir=tmp_dir, name="XGBoost_Optuna")
    ...
    def objective(trial):
        ...
        tb_logger.log_metrics({"rmse": error}, step=trial.number)
        return error
